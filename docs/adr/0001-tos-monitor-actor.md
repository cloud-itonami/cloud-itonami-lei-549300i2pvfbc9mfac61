...
Teladoc Health, Inc., per ADR-2607110300 -- a read-only reference
archive. As part of a fifth 10-repo validation batch extending the
`cloud-itonami-lei-2572ibtt8cczw6au4141` pilot (see ADR-2607241900/
ADR-2607242600 for the full fleet-level design rationale), this repo
gains a governed actor layer on top of the unchanged archive.
...
- **Company**: Teladoc Health, Inc., LEI 549300I2PVFBC9MFAC61, website
  `https://www.teladochealth.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url
  `https://www.teladochealth.com/legal/terms-of-service`, retrieved-at
  `2026-07-10T11:04:56Z`, doc-type `:terms-of-service`.
